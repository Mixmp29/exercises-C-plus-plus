// Упражнение 15.7. Определите класс, реализующий ограниченную стратегию скидок,
// которая применяет скидку только к покупкам до заданного предела. Если
// количество экземпляров превышает этот предел, к остальным применяется обычная
// цена.
