// Упражнение 7.40. Выберите одну из следующих абстракций (или абстракцию по
// собственному выбору). Определите, какие данные необходимы в классе.
// Предоставьте соответствующий набор конструкторов. Объясните свои решения.

// Пусть будет Diary - ежедневник который будет содержать дату и записи на нее
// (пункты задач на день).
...
// Считывание значений из терминала. Возвращает объект istream;
