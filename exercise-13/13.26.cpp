// Упражнение 13.26. Напишите собственную версию класса StrBlob, описанного в
...
class StrBlob {
 ...
 public:
  ...
  StrBlob(const StrBlob& rhs)
      // Создаем новую область видимости для скопированного вектора.
      : data(std::make_shared<std::vector<std::string>>(*rhs.data)) {}

  StrBlob& operator=(const StrBlob& rhs) {
    // Достаточно взять указатель на копию вектора
    data = std::make_shared<std::vector<std::string>>(*rhs.data);
    // Кстати, такой вызов будет эквивалентен:
