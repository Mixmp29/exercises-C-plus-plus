// Упражнение 14.7. Определите оператор вывода для класса String, написанного
// для упражнений раздела 13.5 (стр. 671).
...
std::ostream &operator<<(std::ostream &os, const String &str) {
  // Итераторы begin() и end() присутствуют, для использования for range.
