// Упражнение 14.15. Должен ли класс, выбранный в упражнении 7.40 раздела 7.5.
// (стр. 377), определять какие-либо арифметические операторы? Если да, то
// реализуйте их. В противном случае объясните, почему нет.

// Можно хотя бы добавить '+='. Остальные операторы скорее будут путать.
