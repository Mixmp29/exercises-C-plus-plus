// Упражнение 14.17. Должен ли класс, выбранный в упражнении 7.40 раздела 7.5.1
// (стр. 377), определять операторы равентства? Если да, то реализуйте их. В
// противном случае объясните, почему нет.

// Можно сделать сравнение дат у ежедневника.
